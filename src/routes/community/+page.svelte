					...
					<div class="aw-hero is-align-start aw-u-max-width-580">
						...
						<div class="">
							<p class="aw-description">
								...
								help us make Appwrite better for developers all around the world.
							</p>
			...
			<div class="aw-big-padding-section-level-2">
				<div class="aw-container">
					<div class="aw-hero is-mobile-center aw-u-gap-20 aw-u-max-width-900">
						...
						<div class="">
							<p class="aw-description">
								Appwrite improves daily thanks to our diverse, inspiring contributors. They come
								from various backgrounds and experience levels, welcoming anyone to join and help us
								excel.
							</p>
				...
				<div class="aw-container">
					<div class="aw-hero is-center">
						...
						<p class="aw-description">
							...
							or to showcase what you have built. Join hundreds of developers.
						</p>
						<a
				...
				<div class="aw-container">
					<div class="aw-grid-15-25-desktop aw-u-row-gap-48 aw-u-column-gap-96">
						<div class="aw-hero is-align-start aw-u-max-width-380">
							...
							<p class="aw-description">
								Discover more about Appwrite by visiting our community across platforms.
							</p>
						</div>
