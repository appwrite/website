...
<Main>
  <div class="web-big-padding-section overflow-hidden">
    <div class="web-big-padding-section-level-1 relative overflow-hidden">
      <div
        class="web-u-hide-mobile absolute -z-1"
    ...
    <div class="web-big-padding-section-level-1 relative">
      ...
      <div class="web-big-padding-section-level-2">
        <div class="container relative">
          <div class="web-hero is-mobile-center web-gap-5 web-max-w-[900px]">
            ...
            <div>
              ...
              <div
                class="u-margin-block-start-32 flex flex-wrap justify-center gap-3"
              >
                <a
    ...
    <div class="web-big-padding-section-level-1">
      <div class="web-big-padding-section-level-2">
        <div class="container">
          ...
          >
            <div
              class="web-u-flex-direction-column-mobile web-gap-24
      ...
      <div class="web-big-padding-section-level-2">
        <section class="container">
          ...
          <ul
            class="grid-box web-gap-5-mobile u-margin-block-start-20 gap-8"
            style="--grid-item-size:15rem"
          >
            <li>
              <div
                class="web-card is-normal has-border-gradient web-gap-2 flex flex-col"
              >
        ...
        <div class="container">
          <div class="web-hero is-center">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="web-button is-secondary web-self-center u-margin-block-start-16"
            >
    ...
    <div class="web-big-padding-section-level-1 web-white-section light">
      <div class="web-big-padding-section-level-2">
        <div class="container">
          ...
          >
            <div class="web-hero is-align-start web-max-w-[380px]">
