<script lang="ts">
    ...
    const description = "Appwrite's threads page reflects our community interactions on Discord. Join the conversation, ask any questions or help other members with their issues.";
