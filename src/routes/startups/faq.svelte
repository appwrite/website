<script lang="ts">
    ...
    export let items: {
        ...
        },
        {
            ...
            answer: "We're supporting startups established in the last decade. We welcome early-stage startups but also startups established within the last decade. So whether you are still looking to build your backend or want to switch to Appwrite, we welcome you to join."
        },
        {
