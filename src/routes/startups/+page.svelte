...
<Main>
  <img
    class="u-inset-inline-end-0 u-inset-block-start-0 u-inset-0 absolute mx-auto block"
    src={BackgroundHero}
    alt=""
  />
  <img
  ...
  <div class="web-big-padding-section relative overflow-hidden">
    <div class="web-big-padding-section-level-1 relative">
      <div class="web-big-padding-section-level-2 e-u-margin-block-128-desktop">
        <section class="container web-u-padding-block-end-0">
          ...
          >
            ...
            <p
              class="web-description web-max-w-[640px] e-u-padding-inline-32-desktop mx-auto"
            >
            ...
            <Button
              ...
              class="web-button u-margin-block-start-12 mx-auto"
            >
              Apply now
            </Button>
          </div>
      ...
      >
        <section class="container">
          <ul
            class="web-u-flex-vertical-mobile web-gap-20 e-gap-24-mobile flex"
          >
            <li
            ...
            >
              <img
                ...
                alt=""
              />
              <div class="u-text-center flex flex-col gap-2">
    ...
    >
            ...
            <ol class="web-timeline-content-list">
              <li>
                ...
                >
                  ...
                  <div>
                    <div class="web-card is-white web-gap-5 flex flex-col">
              ...
              <li class="web-timeline-content-item">
                ...
                >
                  <div class="flex flex-col gap-4">
                    ...
                    <div
                      class="web-card is-white web-gap-5 web-u-margin-block-start-64 e-u-margin-block-start-16-mobile flex flex-col"
                    >
              ...
              <li class="web-timeline-content-item">
                ...
                >
                  <div
                    class="e-u-order-1-mobile e-mx-auto-mobile u-width-full-line web-max-w-[580px]"
                  >
                    <div
                      class="web-chat web-max-w-[580px] web-u-margin-block-start-40-mobile"
                    >
      ...
      <div
        class="web-big-padding-section-level-2 e-u-margin-block-start-200-desktop e-u-margin-block-start-128-mobile overflow-hidden"
      >
        <h4
          class="web-title web-u-color-text-primary u-text-center mx-auto max-w-[350px]"
        >
    ...
    <div
      id="form"
      class="web-big-padding-section-level-1 u-padding-0 overflow-hidden"
    >
      <div
        ...
        <div class="relative">
          <div class="web-big-padding-section-level-2">
            <div class="container relative">
              ...
              <!-- before submit -->
              <div
                class="grid-cols-2-opt-2 e-u-row-gap-0 relative z-1 grid gap-8"
              >
                <div>
                  <div
                ...
                {#if submitted}
                  <div
                    class="u-text-center web-max-w-[380px] web-u-max-inline-size-none-mobile relative z-1 mx-auto flex flex-col gap-2"
                  >
                    <h6
                    ...
                    <button
                      on:click={resetForm}
                      class="web-button is-secondary is-full-width-mobile u-margin-block-start-16 mx-auto block"
                      >Back to form</button
                    >
                  </div>
                {:else}
                  ...
                  >
                    <div class="u-main-end flex">
                      <ul
                        class="web-form-list u-width-full-line web-max-w-[580px] web-u-max-inline-size-none-mobile gap-4"
                      >
                    ...
                    >
                      <p class="web-caption-400 web-max-w-[380px]">
                        {#if error}
                          {error}
                        {/if}
                      </p>
