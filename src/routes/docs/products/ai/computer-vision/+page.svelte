...
>
    ...
    <Carousel size="medium">
        {#each tutorials as tutorial}
            <li>
                <a href={tutorial.href} class="aw-card is-normal u-height-100-percent">
                    <img
    ...
    <h1 class="aw-label aw-u-color-text-primary web-snap-location">
    ...
    <section>
        <h2 class="aw-label aw-u-color-text-primary web-snap-location">References</h2>
        <ol class="aw-numeric-list">
            <li id="1">
                <a
                    class="aw-link u-underline"
