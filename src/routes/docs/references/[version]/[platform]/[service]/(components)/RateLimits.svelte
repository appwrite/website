    ...
    <div class="flex flex-col gap-4">
      {#if platformType === "CLIENT"}
        <p class="web-sub-body-400">
          ...
          request to his endpoint within a specific time frame.
        </p>
      {:else}
        <p class="web-sub-body-400">
          This endpoint is not limited when using Server SDKs with API keys. If
          you are using SSR with <code>setSession</code>, these rate limits will
          still apply.
          <a
