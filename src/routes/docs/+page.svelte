...
<Docs variant="default">
	...
	<Spline let:fallback let:viewer>
		...
		<div
			class="u-position-absolute aw-is-not-mobile"
			style="inline-size:647px; inset-block-start:24rem; inset-inline-start:calc(100% - 500px)"
		>
			<spline-viewer
	...
	<main class="aw-main-section u-position-relative">
		...
		<section class="aw-hero is-align-start is-no-max-width">
			...
			<div class="aw-articles">
				<ul class="aw-articles-list">
					<li>
						<a
						...
						>
							<article class="aw-articles-item">
								<img
									...
									loading="lazy"
								/>
								<div class="aw-articles-item-content">
									<header class="aw-articles-item-header">
										<h3 class="aw-sub-body-500">React sign up template</h3>
									</header>
									<p
