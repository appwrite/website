    ...
    >
        ...
        >
            <header class="flex h-12 w-full items-center px-4">
                ...
                <div
                    class="flex h-6 w-xs items-center rounded-full bg-[#1B1B1C]/94 px-2 backdrop-blur-lg"
                >
                    <span
                        class="text-secondary flex items-center gap-1 text-[0.625rem] -tracking-[.045%]"
                        ><span class="web-icon-github" />Current repository:<span class="text-white"
                            >my-repo</span
                        ></span
                    >
                </div>
