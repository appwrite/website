...
<div
    class="flex max-w-xs flex-col items-center justify-center gap-4 rounded-2xl border border-white/[0.02] bg-gradient-to-br from-white/[0.02] to-white/[0.005] p-8 text-center"
>
    <div class="space-y-1">
