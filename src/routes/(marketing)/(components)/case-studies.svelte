...
<div
    class={classNames(
        'border-smooth relative mb-0 flex min-h-[60vh] items-center justify-center overflow-hidden border-t bg-gradient-to-b from-black/40 to-black/16 pt-30 pb-40',
    ...
    >
        {#each studies as study, i}
            <ToggleGroup.Item
                value={i.toString()}
                class={classNames(
                    'data-[state="on"]:border-smooth align-items-center relative z-100 grid justify-items-center overflow-hidden rounded-2xl border border-transparent p-12 py-12 backdrop-blur-3xl transition-all duration-400 ease-in-out [grid-template-areas:"stack"] data-[state="off"]:cursor-pointer md:max-h-[391px] md:place-content-center md:place-items-center md:items-center md:justify-center',
            ...
            >
                ...
                <div
                    class={classNames(
                        'invisible space-y-8 opacity-0 blur-sm transition-opacity delay-400 [grid-area:stack]',
                ...
                >
                    ...
                    >
                        ...
                        <div class="mt-4 flex flex-col justify-between gap-4 lg:flex-row">
                            ...
                            <a
                                href={study.url}
                                class="text-primary text-sub-body group mt-4 flex cursor-pointer items-center gap-2 text-right md:mt-0"
