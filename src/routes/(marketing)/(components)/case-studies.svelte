    ...
    >
        {#each studies as study, i}
            <ToggleGroup.Item
                value={i.toString()}
                class={classNames(
                    'data-[state="on"]:border-smooth align-items-center relative z-100 grid h-fit! justify-items-center overflow-hidden rounded-2xl border border-transparent p-12 py-12 backdrop-blur-3xl transition-all duration-400 ease-in-out [grid-template-areas:"stack"] data-[state="off"]:cursor-pointer md:place-content-center md:place-items-center md:items-center md:justify-center',
