...
>
    <div class="container mx-auto">
        <section class="flex flex-col gap-4 lg:flex-row lg:gap-x-20 lg:items-baseline">
            <h2
            ...
            <p class="text-secondary text-description mt-4 max-w-full lg:max-w-xl font-medium">
