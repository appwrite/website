...
<div class={cn('relative w-full', classNames)} {...restProps}>
	...
	<a
		...
		class="group relative mx-auto flex w-full items-center py-4 md:h-[76px] bg-black cursor-pointer"
	>
		...
		<!-- Content -->
		<div class="mx-auto flex w-full gap-[1rem] [max-inline-size:108rem] relative z-10">
			<!-- Left Side: Introducing + Logo + Imagine -->
			<div class="md:basis-1/2 flex items-center gap-4">
			...
			<div class="mr-0 ml-auto text-right flex items-center gap-2">
