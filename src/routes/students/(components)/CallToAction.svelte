...
<div
    class={classNames(
        'border-greyscale-200/[0.04] relative -mb-24 flex min-h-[600px] items-center justify-center border-y pt-20',
...
>
    <div class="container">
        <div class="flex max-w-3xl flex-col items-center justify-center gap-8 text-center">
