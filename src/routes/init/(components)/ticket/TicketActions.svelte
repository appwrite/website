    ...
    <div class="u-flex u-gap-16">
      {#if ticket.gh_user}
        <div class="u-flex u-gap-8 items-center">
          <div class="u-flex u-gap-8 web-u-color-text-primary items-center">
          ...
          <Tooltip placement="bottom">
            ...
            <svelte:fragment slot="tooltip"
              >Show GitHub contributions</svelte:fragment
            >
          </Tooltip>
        </div>
      {:else}
...
{:else}
  <div class="buttons" style:justify-content="space-between">
    <button
      class="web-button customize-button"
      on:click={() => (customizing = !customizing)}
    >
