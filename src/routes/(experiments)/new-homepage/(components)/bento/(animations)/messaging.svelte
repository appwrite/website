...
>
    ...
    >
        <div
            class="light absolute top-16 z-10 flex h-20 w-[340px] items-center justify-between gap-3 rounded-[20px] bg-white/80 py-1 px-3 shadow-[-8px_4px_32px_rgba(0,0,0,0.24)] backdrop-blur-xl"
        >
