...
<div
    class="border-smooth mask relative flex min-h-[70vh] w-full flex-col gap-4 overflow-hidden border-y bg-black/8 py-20"
    use:useInView
        ...
        <div class="container relative h-full">
            <div class="absolute inset-0 z-100 grid grid-cols-4">
                {#each stats as stat, i}
                    <div
                        class="mask border-smooth h-full border-l"
