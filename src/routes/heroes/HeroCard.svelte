...
<script lang="ts">
    ...
    export let bio: $$Props['bio'];
    export let github: $$Props['github'] = undefined;
    export let twitter: $$Props['twitter'] = undefined;
    export let linkedin: $$Props['linkedin'] = undefined;
