    ...
    <div class="web-big-padding-section-level-1">
      <div class="web-big-padding-section-level-2">
        <section class="container">
          <div class="web-hero web-max-w-[800px] about">
          ...
          <ul class="inner">
            ...
            {#each { length: 5 } as _, i}
              <li>
                ...
                >
                  <img
                    class="web-u-border-radius-12 block"
        ...
        <div class="container">
          <div class="web-hero web-max-w-[800px]">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="web-button is-transparent is-full-width-mobile web-self-center u-margin-block-start-20"
            >
              Become a Hero
            </a>
          </div>
