    ...
    <div class="relative">
      <article use:melt={$root}>
        <div class="web-container">
          ...
          <div
            class="web-is-only-mobile web-u-padding-block-start-48 web-u-margin-inline-8-negative web-u-filter-blur-8 /sticky /u-z-index-5 ps-2 pe-2"
          ...
          <div
            class="web-is-not-mobile web-u-grid-auto-column-1fr is-with-footer-border web-u-margin-inline-8-negative web-u-filter-blur-8 web-u-container-query-inline sticky z-[5] gap-8 ps-2 pe-2"
          ...
          >
            ...
            <div class="web-mini-card">
              <div
                class="u-cross-center u-main-space-between flex flex-wrap gap-4"
              >
