...
<Main>
    <div class="web-big-padding-section">
        <div class="web-big-padding-section-level-1 dark">
            ...
            <div class="web-big-padding-section-level-2">
                <section class="web-container">
                    ...
                    <ul class="grid-cols-2-opt-2 web-u-margin-block-start-80 grid gap-8">
                        <li>
                            <article
        ...
        <div class="web-big-padding-section-level-1 dark relative overflow-hidden">
