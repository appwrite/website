...
<div class="u-position-absolute u-overflow-hidden" style="pointer-events:none;">
    <svg  class="aw-u-gradient-mobile-align"
        ...
        <g filter="url(#filter1_f_1330_36780)">
            <ellipse cx="835.777" cy="337.091" rx="156.5" ry="468.5" transform="rotate(66.0796 835.777 337.091)" fill="url(#paint1_radial_1330_36780)" fill-opacity="0.5"/>
        </g>
        <g filter="url(#filter2_f_1330_36780)">
            <ellipse cx="737.509" cy="316.973" rx="92.2783" ry="276.245" transform="rotate(66.0796 737.509 316.973)" fill="url(#paint2_radial_1330_36780)" fill-opacity="0.5"/>
        </g>
        <defs>
            <filter id="filter0_f_1330_36780" x="-19.1348" y="-11.3857" width="1037.1" height="724.895" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                <feFlood flood-opacity="0" result="BackgroundImageFix"/>
                <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
                <feGaussianBlur stdDeviation="50" result="effect1_foregroundBlur_1330_36780"/>
            </filter>
            <filter id="filter1_f_1330_36780" x="302.783" y="-0.727051" width="1065.99" height="675.636" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                <feFlood flood-opacity="0" result="BackgroundImageFix"/>
                <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
                <feGaussianBlur stdDeviation="50" result="effect1_foregroundBlur_1330_36780"/>
            </filter>
            <filter id="filter2_f_1330_36780" x="382.199" y="76.7461" width="710.619" height="480.453" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                <feFlood flood-opacity="0" result="BackgroundImageFix"/>
                <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
                <feGaussianBlur stdDeviation="50" result="effect1_foregroundBlur_1330_36780"/>
            </filter>
            <radialGradient id="paint0_radial_1330_36780" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(499.417 351.062) rotate(90) scale(468.5 156.5)">
                <stop stop-color="#F02E65"/>
                <stop offset="1" stop-color="#F02E65" stop-opacity="0"/>
            </radialGradient>
            <radialGradient id="paint1_radial_1330_36780" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(835.777 337.091) rotate(90) scale(468.5 156.5)">
                <stop stop-color="#FE9567"/>
                <stop offset="1" stop-color="#F02E65" stop-opacity="0"/>
            </radialGradient>
            <radialGradient id="paint2_radial_1330_36780" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(737.509 316.973) rotate(90) scale(276.245 92.2783)">
