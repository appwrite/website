                ...
                <div class="aw-content is-count-headers">
                    <section id="introduction">
                        ...
                        <ol class="aw-order-list-level-1">
                            <li>
                                When you browse or visit our website, <a href="/" class="aw-link">https://appwrite.io/</a> (“Website”)
                            </li>
                            <li>
                                ...
                                <ol class="aw-order-list-level-2">
                                    ...
                                    <li>When you subscribe to our distribution list(s) / newsletter(s) / blog(s)</li>
                                    <li>When you submit a job application</li>
                                    <li>When you contact us (e.g. customer support, need help, submit a request, when you report a security vulnerability)</li>
                                    <li>When you apply for our fund</li>
                                </ol>
                            </li>
                            <li>
                                When you make use of, or interact with, our  application, and any other application, that we license (each individually, and collectively, the “App”).  
                                <ol class="aw-order-list-level-2">
                                    <li>When you create an account and when you log in </li>
                                </ol>
                            </li>
                            <li>When you attend a marketing event and/or we exchange business cards and you provide us with your Personal Data </li>
                            <li>When we use the Personal Data of our customers (e.g. contact details) </li>
                            <li>When you interact with us on our social media profiles (e.g., Facebook, GitHub, Twitter, LinkedIn).</li>
                        </ol>
                        </div>

                        <p>Hereinafter the Website and the App will be referred to as the “Service”.
                            ...
                            <div class="aw-info-table-wrapper">
                                ...
                                <tbody class="aw-info-table-tbody">
                                    ...
                                    <tr class="aw-info-table-col-row">
                                        ...
                                        <td class="aw-info-table-col">Marketing purposes, usage analytics and statistics, improving quality of service</td>
                                    </tr>
                                    <tr class="aw-info-table-col-row">
                                    ...
                                    <tr class="aw-info-table-col-row">
                                        ...
                                        <td class="aw-info-table-col">
                                            For more information, please read our cookies policy <a href="https://appwrite.io/policy/cookies" target="_blank">https://appwrite.io/policy/cookies</a>

                                        </td>
                                    </tr>
                                    <tr class="aw-info-table-col-row">
                                        <th class="aw-info-table-col-header">Consequences of not providing the personal data</th>
                                        <td class="aw-info-table-col">Certain non-essential Website features may not be available </td>
                                    </tr>
                                </tbody>
                            </table>
                            </div>
                                ...
                                <table class="aw-info-table">
                                    ...
                                    <tr class="aw-info-table-col-row">
                                        ...
                                        <td class="aw-info-table-col">
                                            <ul>
                                                ...
                                                <li>Phone number</li>
                                                <li>Payment information (e.g., 4 last digits of the credit card number)</li>
                                    ...
                                    <tr class="aw-info-table-col-row">
                                        ...
                                        <td class="aw-info-table-col">
                                            <ul>
                                                <li>Processing is necessary for the performance of a contract to which the data subject is party or in order to take steps at the request of the data subject prior to entering into a contract</li>
                                                <li>Legitimate interest (e.g. to allow you to purchase Appwrite's swag products)</li>
                                            </ul>
                                        </td>
                                    </tr>
                                    <tr class="aw-info-table-col-row">
                                ...
                                <table class="aw-info-table">
                                    ...
                                    <tr class="aw-info-table-col-row">
                                        ...
                                        <td class="aw-info-table-col">
                                            <ul>
                                                <li>Consent</li>
                                                <li>Legitimate interest (e.g. send you more information about Appwrite)</li>
                                            </ul>
                                        </td>
                                    </tr>
                                    <tr class="aw-info-table-col-row">
                    ...
                    <section>
                        <h3 class="aw-sub-body-500 aw-u-color-text-primary">
                            When you contact us (e.g. customer support, need help, submit a request or when you report a security vulnerability)
                        </h3>
                        <div class="aw-info-table-scroll">
                            <div class="aw-info-table-wrapper">
                                <table class="aw-info-table">
                    ...
                    <section>
                        <h3 class="aw-sub-body-500 aw-u-color-text-primary">
                            When you interact with us on our social media profiles (e.g., Facebook, GitHub, Twitter, LinkedIn, Discord)
                        </h3>
                        <div class="aw-info-table-scroll">
                            <div class="aw-info-table-wrapper">
                                <table class="aw-info-table">
                                    ...
                                    <tr class="aw-info-table-col-row">
                                        ...
                                        <td class="aw-info-table-col">
                                            <ul>
                                                ...
                                                <li>Any other data that you decide to supply/provide us and/or publicly available on your social media account</li>
                                            </ul>
                                        </td>
                                    </tr>
                                    <tr class="aw-info-table-col-row">
                                    ...
                                    <tr class="aw-info-table-col-row">
                                        ...
                                        <td class="aw-info-table-col">
                                            3rd party platforms such as for the following purposes:
                                            <ul>
                                                <li>Social media platforms (e.g. Facebook,  GitHub, Twitter, LinkedIn, Discord)</li>
                                            </ul>
                                        </td>
                                    </tr>
                                    <tr class="aw-info-table-col-row">
                    ...
                    <section class="count-secondary-title" id="protect">
                        ...
                        <div class="u-flex u-flex-vertical u-gap-8">
                            ...
                            <h3 class="aw-sub-body-500 aw-u-color-text-primary u-margin-block-start-12">Retention of your Personal Data</h3>
                    ...
                    <section class="count-secondary-title" id="share">
                        ...
                        <div class="u-flex u-flex-vertical u-gap-8">
                            ...
                            <h3 class="aw-sub-body-500 aw-u-color-text-primary u-margin-block-start-12"></h3>
                            <p>With our business partners with whom we jointly offer products or services. We may also share Personal Data with our affiliated companies.</p>
                            <h3 class="aw-sub-body-500 aw-u-color-text-primary u-margin-block-start-12"></h3>
                            <p>To the extent necessary, with regulators, courts or competent authorities, to comply with applicable laws, regulations and rules (including, without limitation, federal, state or local laws), and requests of law enforcement, regulatory and other governmental agencies or if required to do so by court order;</p>
                            <h3 class="aw-sub-body-500 aw-u-color-text-primary u-margin-block-start-12"></h3>
                            <p>If, in the future, we sell or transfer, or we consider selling or transferring, some or all of our business, shares or assets to a third party, we will disclose your Personal Data to such third party (whether actual or potential) in connection with the foregoing events;</p>
                            <h3 class="aw-sub-body-500 aw-u-color-text-primary u-margin-block-start-12"></h3>
                            <p>In the event that we are acquired by, or merged with, a third party entity, or in the event of bankruptcy or a comparable event, we reserve the right to transfer, disclose or assign your Personal Data in connection with the foregoing events, including, in connection with, or during negotiations of, any merger, sale of company assets, consolidation or restructuring, financing, or acquisition of all or a portion of our business by or to another company; and/or</p>
                            <h3 class="aw-sub-body-500 aw-u-color-text-primary u-margin-block-start-12"></h3>
                    ...
                    <section class="count-secondary-title" id="privacy">
                        ...
                        <div class="u-flex u-flex-vertical u-gap-8">
                            ...
                            <p>The following rights (which may be subject to certain exemptions or derogations) shall apply to certain individuals (some of which only apply to individuals protected by the GDPR)</p>
                            <ul>
                                <li>You have a right to access Personal Data held about you. Your right of access may normally be exercised free of charge, however we reserve the right to charge an appropriate administrative fee where permitted by applicable law;</li>
                                <li>You have the right to request that we rectify any Personal Data we hold that is inaccurate or misleading;</li>
                                <li>You have the right to request the erasure/deletion of your Personal Data (e.g. from our records). Please note that there may be circumstances in which we are required to retain your Personal Data, for example for the establishment, exercise or defense of legal claims;</li>
                    ...
                    <section class="count-secondary-title" id="analytic">
                        ...
                        <ul class="u-flex u-flex-vertical u-gap-24">
                            ...
                            <li>
                                ...
                                - Orbit is a community analytics service offered by Orbit that tracks and reports community activity. For more information on the privacy practices of Orbit, please visit the Orbit Privacy & Terms web page:
                                <a href="https://orbit.love/privacy-policy/" target="_blank">https://orbit.love/privacy-policy/</a>.
                            </li>
                            <li>
                                <span class="aw-u-color-text-primary">Sentry </span>
                                - Sentry is a monitoring software and a performance monitoring software. Sentry helps diagnose, fix, and optimize the performance of the Website. Sentry's ability to use and share information collected by Sentry is regulated by their terms of service, available at
                                <a href="https://sentry.io/terms/" target="_blank">https://sentry.io/terms/</a>, and their Privacy Policy available at
                                <a href="https://sentry.io/privacy/" target="_blank">https://sentry.io/privacy/</a>.
                            </li>
                            <li>
                                <span class="aw-u-color-text-primary">Mixpanel </span>
                                - Mixpanel is a website that collects information about use of our console. It collects information such as how often users visit this console, what pages they visit when they do so, but not PII. We use the information we get from Mixpanel to maintain and improve the Website and our products. Mixpanel’s ability to use and share information about your visits is restricted by the Terms of Service, available at
                                <a href="https://mixpanel.com/legal/terms-of-use" target="_blank">https://mixpanel.com/legal/terms-of-use</a>
                                and the Mixpanel Privacy Policy, available at
                                <a href="https://mixpanel.com/legal/privacy-policy" target="_blank">https://mixpanel.com/legal/privacy-policy</a>.
                            </li>
                            <li>
                                We reserve the right to remove or add new analytic tools. We reserve the right to remove or add new analytic tools.
                            </li>
                        </ul>
                    </section>
                    <section class="count-secondary-title" id="payments">
                        ...
                        <ul class="aw-pink-dots u-flex u-flex-vertical u-gap-24">
                            <li>
                                <span class="aw-u-color-text-primary">Apple Store In-App Payments</span> - Their Privacy Policy can be viewed at
                                <a href="https://www.apple.com/legal/privacy/en-ww/" target="_blank">https://www.apple.com/legal/privacy/en-ww/</a>
                            </li>
                            <li>
                                <span class="aw-u-color-text-primary">Google Play In-App Payments</span> - Their Privacy Policy can be viewed at
                                <a href="https://www.google.com/policies/privacy/" target="_blank">https://www.google.com/policies/privacy/</a>
                            </li>
                            <li>
                                <span class="aw-u-color-text-primary">Stripe</span> - Their Privacy Policy can be viewed at
                                <a href="https://stripe.com/us/privacy" target="_blank">https://stripe.com/us/privacy</a>
                            </li>
                            <li>
                                <span class="aw-u-color-text-primary">Paypal/Braintree</span> - Their Privacy Policy can be viewed at
                                <a href="https://www.paypal.com/webapps/mpp/ua/privacy-full" target="_blank">https://www.paypal.com/webapps/mpp/ua/privacy-full</a>
                            </li>
                        </ul>
                    </section>
                    ...
                    <section class="count-secondary-title" id="contact">
                        ...
                        <p>
                            f you have any questions, concerns or complaints regarding our compliance with this notice and the data protection laws, or if you wish to exercise your rights, we encourage you to first contact us at <a href="mailto:privacy@appwrite.io" target="_blank">privacy@appwrite.io</a>.
