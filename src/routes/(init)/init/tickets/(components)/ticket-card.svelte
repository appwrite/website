...
<button class="perspective-[1500px]" on:click={handleFlip}>
    <div
        use:tilt
        class="size-full overflow-hidden rounded-2xl transition-all duration-300 ease-out"
    >
        <div
            class={classNames(
                'group relative z-10 mx-auto flex aspect-[3.65/5.72] max-w-sm min-w-sm flex-col gap-1 rounded-2xl bg-[#27272A] p-1 shadow-lg transition-transform transform-3d',
