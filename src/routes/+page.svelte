			...
			<div class="aw-big-padding-section-level-2">
				<div class="aw-container">
					<section class="aw-hero is-align-start">
						...
						<h2 class="aw-display aw-u-color-text-primary u-max-width-700">Self-host your data or take it to the Cloud</h2>
			...
			>
				...
				<div class="aw-container u-position-relative">
					<div class="grid-1-1">
						...
						<ul class="aw-big-list-info u-margin-inline-start-auto aw-u-inline-width-100-percent-mobile-break1 aw-u-margin-block-start-48">
