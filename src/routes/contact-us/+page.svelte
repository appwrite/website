<script lang="ts">
	...
	const metatitle = TITLE_PREFIX + 'Discord - Join our thriving community!';
	const description = "Contact Appwrite: We're here to help you with any questions or requests you have.";
