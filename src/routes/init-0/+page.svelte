...
<Main>
  <div class="hero">
    ...
    <div class="buttons">
      <button
        on:click={() => scrollIntoView("#kickoff")}
    ...
    <div class="container">
      <div class="text">
        ...
        <p class="web-main-body-500">
          Appwrite's open-source platform lets you add Auth, DBs, Functions and
          Storage to your product and build any application at any scale, own
          your data, and use your preferred coding languages and tools.
        </p>
