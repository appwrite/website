...
| Access control | API key and folder-level | Granular user and team permissions |
| Self-hosting | No | Yes |
| Data ownership | Vendor's cloud | Your infrastructure (self-hosted) |
| Pricing model | Credit-based, per transformation | Per storage volume and requests |
| Part of a full backend platform | No | Yes |
| Antivirus scanning | No | Yes (with ClamAV) |
