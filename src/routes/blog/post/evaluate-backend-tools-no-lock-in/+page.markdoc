...
date: 2024-07-19
cover: /images/blog/evaluate-backend-tools-no-lock-in/cover.png
timeToRead: 6
...
### 5. The migration path from the alternative
...
- **Data portability**: Appwrite stores data in standard JSON document format. Data can be exported without contacting the vendor, and the format is immediately usable in other systems.
