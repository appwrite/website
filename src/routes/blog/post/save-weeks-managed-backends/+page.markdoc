...
date: 2024-09-27
cover: /images/blog/save-weeks-managed-backends/cover.png
timeToRead: 6
...
- **Database** is set up by creating collections with defined schema and indexes. The query API is available immediately. No API layer to build.
...
- **Database and query API immediately**: Create a collection, define your attributes and indexes in the console or via the CLI, and start querying. Filtering, ordering, and pagination are built into the SDK. No API layer to build.
