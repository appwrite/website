                ...
                <div class="u-flex u-main-space-between u-cross-center u-gap-16">
                    <div class="u-flex-vertical u-gap-2">
                        <div class="u-flex u-cross-end u-gap-8">
                            ...
                            <h6 class="aw-sub-body-500 aw-u-color-text-accent-click" style="line-height:15px">join us for Day 3</h6>
                        </div>
                        <p class="aw-caption-500">Database operators announced</p>
                    </div>
                    <div class="u-flex-vertical u-gap-2">
