...
<div
    class="border-smooth box-content flex items-center border-b bg-[url(/images/bgs/mobile-hero.avif)] bg-cover bg-bottom px-5 py-12 md:bg-[url(/images/bgs/hero.avif)] md:bg-center md:pt-32 md:pb-40 lg:px-8 xl:px-16"
>
