  ...
  <TocRoot>
    <div class="container">
      <div class="web-grid-120-1fr-auto">
        ...
        <button
          class="toc-btn u-width-full-line web-u-padding-20 web-u-margin-inline-20-negative web-u-color-text-primary web-is-only-mobile
                u-margin-block-start-24 web-u-sep-block web-u-filter-blur-8 sticky
