...
ARG APPWRITE_INIT_DB_ID
ENV APPWRITE_INIT_DB_ID ${APPWRITE_INIT_DB_ID}

ARG APPWRITE_INIT_COLLECTION_ID
ENV APPWRITE_INIT_COLLECTION_ID ${APPWRITE_INIT_COLLECTION_ID}
